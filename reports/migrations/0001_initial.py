...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_from', models.DateTimeField(null=True, verbose_name='Дата с')),
                ('date_to', models.DateTimeField(null=True, verbose_name='Дата по')),
                ('send_time', models.DateTimeField(null=True, verbose_name='Время отправки')),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reports.email')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
